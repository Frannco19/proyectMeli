...
public final class UtUtils {
    ...
    public static void setField(Object object, String fieldClassName, String fieldName, Object fieldValue) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException, IllegalAccessException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields625287316533400 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields625287316533400.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass625287316543300 = (java.lang.reflect.Field[]) methodForGetDeclaredFields625287316533400.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass625287316543300).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static void setStaticField(Class<?> clazz, String fieldName, Object fieldValue) throws NoSuchFieldException, IllegalAccessException {
        ...
        try {
            ...
            java.lang.reflect.Method methodForGetDeclaredFields625287318159000 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
            methodForGetDeclaredFields625287318159000.setAccessible(true);
            java.lang.reflect.Field[] allFieldsFromFieldClass625287318160600 = (java.lang.reflect.Field[]) methodForGetDeclaredFields625287318159000.invoke(java.lang.reflect.Field.class, false);
            modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass625287318160600).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getFieldValue(Object obj, String fieldClassName, String fieldName) throws ClassNotFoundException, NoSuchMethodException, java.lang.reflect.InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields625287320377700 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields625287320377700.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass625287320379200 = (java.lang.reflect.Field[]) methodForGetDeclaredFields625287320377700.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass625287320379200).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getStaticFieldValue(Class<?> clazz, String fieldName) throws IllegalAccessException, NoSuchFieldException {
        ...
        do {
            try {
                ...
                java.lang.reflect.Method methodForGetDeclaredFields625287322197600 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
                methodForGetDeclaredFields625287322197600.setAccessible(true);
                java.lang.reflect.Field[] allFieldsFromFieldClass625287322199300 = (java.lang.reflect.Field[]) methodForGetDeclaredFields625287322197600.invoke(java.lang.reflect.Field.class, false);
                modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass625287322199300).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    private static java.lang.invoke.MethodHandles.Lookup getLookupIn(Class<?> clazz) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields625287338594600 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields625287338594600.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass625287338598800 = (java.lang.reflect.Field[]) methodForGetDeclaredFields625287338594600.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allowedModes = java.util.Arrays.stream(allFieldsFromFieldClass625287338598800).filter(field1 -> field1.getName().equals("allowedModes")).findFirst().get();


        java.lang.reflect.Method methodForGetDeclaredFields625287338613000 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields625287338613000.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass625287338613900 = (java.lang.reflect.Field[]) methodForGetDeclaredFields625287338613000.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allModesField = java.util.Arrays.stream(allFieldsFromFieldClass625287338613900).filter(field1 -> field1.getName().equals("ALL_MODES")).findFirst().get();
