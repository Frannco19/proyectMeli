...
public class CostServiceImpl implements CostService {
    ...
    public CostServiceImpl(CostRepository costRepository, MeliService meliService, ModelMapper mapper, ItemService itemService) {
    ...
    public void createProductsCosts() {
        ...
        items.parallelStream().forEach((item -> {
            ...
            cost.setShipping(meliService.getShippingCostDTO(item.getId()).getOptions().getBase_cost());
